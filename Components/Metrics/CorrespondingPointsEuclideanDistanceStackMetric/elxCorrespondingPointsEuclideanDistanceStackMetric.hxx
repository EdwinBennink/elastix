 ...
 *
 *=========================================================================*/
#ifndef __elxCorrespondingPointsEuclideanDistanceStackMetric_HXX__
#define __elxCorrespondingPointsEuclideanDistanceStackMetric_HXX__

#include "elxCorrespondingPointsEuclideanDistanceStackMetric.h"
...
::Initialize( void )
{
  ...
  timer.Stop();
  elxout << "Initialization of CorrespondingPointsEuclideanDistanceStack metric took: "
...
::BeforeAllBase( void )
{
    ...
    ->CountNumberOfParameterEntries( "Metric" ); ++i )
  {
    ...
    if( metricName == "CorrespondingPointsEuclideanDistanceStackMetric" ) { count++; }
  }
  if( count == 0 ) { return 0; }

  /** Check Command line options and print them to the log file. */
  elxout << "Command line options from CorrespondingPointsEuclideanDistanceStackMetric:" << std::endl;
  std::string check( "" );
...
#endif // end #ifndef __elxCorrespondingPointsEuclideanDistanceStackMetric_HXX__
